...
public class MinMaxFloat
{
    ...
    {
        get { return (_value - min) / (_max - min); }
    }
...
public class MinMaxEventFloat : MinMaxFloat
{
    ...
    public delegate void EventHandlerFloat2(float from, float to);

    public EventHandlerFloat OnValueChangeBy = null;
    public EventHandlerFloat OnValueChangeTo = null;
    public EventHandlerFloat2 OnValueChangeFromTo;
    ...
    public override float value
    {
        ...
        set
        {
            ...
            if (OnValueChangeFromTo != null) OnValueChangeFromTo(oldValue, _value);
